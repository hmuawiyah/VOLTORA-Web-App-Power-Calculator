...
const PowerEstimation = () => {
    ...
    return (
        <Card className="gap-2" id="my-node">
            ...
            <CardContent>
                <div className="flex justify-between border bg-linear-to-t from-[#d3e8ff20] to-[#d3e8ff] rounded-xl p-3 h-30">
                    ...
                    <div className="flex flex-col justify-between w-1/2">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm"> {totalkWh.toFixed(2)} kWh </span>
                    ...
                    <div className="flex w-1/2">
                        ...
                        <div className="flex flex-col justify-between ml-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-sm"> {(totalkWh * 30).toFixed(2)} kWh </span>
                ...
                <div className="flex flex-col justify-between border bg-linear-to-t from-[#fff7e620] to-[#fff7e6] h-23 p-3 mt-4 rounded-xl">
                    ...
                    <div className="flex justify-between text-lg font-semibold">
                        <span>
                            Rp {getPrice().kwh?.toFixed(2).toLocaleString("id-ID") ?? 0}/kWh
                        </span>
                        <span>
                    ...
                    {items.length > 0 && items.map((item, i) => (
                        <div key={i}>
                            <div className="flex items-center justify-between px-5 py-4 text-xs lg:text-sm">
                                ...
                                <span className="text-muted-foreground text-right w-[30%]">{(item.power * item.hrs * item.qty / 1000).toFixed(2)} kWh</span>
